...
function setup() {
  ...
  wall5=new wall(displayWidth-525,300,30,100);
  ...
  wall16=new wall(displayWidth-575,200,100,30);
  ...
  wall24=new wall(displayWidth-575,400,100,30);
  ...
  wall29=new wall(200,50,30,268);
  wall30=new wall(200,466,30,100);
  wall31= createSprite(displayWidth-488,400,70,30);
 
  wall32=new wall(200,466,30,100);  
